...
HWND _stdcall ListLoadW(HWND ParentWin,WCHAR* FileToLoad,int ShowFlags);
...
int _stdcall ListPrint(HWND ListWin,char* FileToPrint,char* DefPrinter,int PrintFlags,RECT* Margins);
int _stdcall ListPrintW(HWND ListWin,WCHAR* FileToPrint,WCHAR* DefPrinter,int PrintFlags,RECT* Margins);
