...
internal static partial class TimelineParser
{
	...
	{
		internal static readonly Regex Value = new Regex(@"^section\s+(.+)$", RegexOptions.None | RegexOptions.Compiled, TimeSpan.FromMilliseconds(TimeoutMs));
	}

	private static Regex PeriodPattern() => Net48PeriodPatternRegexCache.Value;
	private static class Net48PeriodPatternRegexCache
	{
	...
	private static Regex ContinuationPattern() => Net48ContinuationPatternRegexCache.Value;
	private static class Net48ContinuationPatternRegexCache
	{
