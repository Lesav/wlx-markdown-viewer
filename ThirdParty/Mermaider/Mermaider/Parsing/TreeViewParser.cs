...
internal static partial class TreeViewParser
{
	...
	private static Regex ClassAnnotation() => Net48ClassAnnotationRegexCache.Value;
	private static class Net48ClassAnnotationRegexCache
	{
	...
	private static Regex DescriptionAnnotation() => Net48DescriptionAnnotationRegexCache.Value;
	private static class Net48DescriptionAnnotationRegexCache
	{
	...
	private static Regex IconAnnotation() => Net48IconAnnotationRegexCache.Value;
	private static class Net48IconAnnotationRegexCache
	{
		internal static readonly Regex Value = new Regex(@"icon\(([^)]*)\)", RegexOptions.None | RegexOptions.Compiled, TimeSpan.FromMilliseconds(TimeoutMs));
	}

	private static Regex BoxDrawingChar() => Net48BoxDrawingCharRegexCache.Value;
	private static class Net48BoxDrawingCharRegexCache
	{
